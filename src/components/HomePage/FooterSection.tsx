    ...
    <div className='flex align-center justify-center flex-col relative h-[100vh] '>
      ...
      <div className='w-3/4 flex p-5'>
        ...
        <div className='w-1/2 flex flex-col gap-4'>
          <h1>Logo</h1>
          <p className='text-sm'>Zenith Solutions is dedicated to connecting businesses with top-tier talent that not only excels in their roles but also embodies the right attitude to drive your company forward.</p>
