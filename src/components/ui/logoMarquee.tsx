...
import imgSrc8 from "@/public/assets/images/mh.png";
...
import imgSrc12 from "@/public/assets/images/tomas.png";
    ...
    <>
      ...
      <div className="w-full h-auto overflow-x-hidden">
        <div className="relative flex overflow-x-hidden">
          <div className="flex flex-row justify-center items-center py-16 animate-marquee">
          ...
          <div className="flex flex-row py-16 animate-marquee">
            {logo.map((logos, index) => (
              <div
                key={index}
                className="relative mx-[2rem] w-[10rem] h-[2rem] inline-flex justify-center items-center"
