...
const ContactusCard = () => {
  return (
    <div className='flex flex-col items-center'>
      <div className='bg-yellow-600 p-5 w-1/2 h-96 flex rounded-2xl'>
          ...
          <form className='flex justify-left w-full'>
            ...
            <div className='flex flex-col gap-4 px-4 w-full'>
              <div className='flex flex-col w-full'>
                <label className='text-sm text-blue-900 pb-10'>Full name</label>
                <input type='text' className='w-full bg-transparent border-0 border-b-2 border-blue-900 outline-none' />
              </div>

              <div className='flex flex-col w-full'>
                <label className='text-sm text-blue-900 pb-10'>Email</label>
                <input type='text' className='w-full bg-transparent border-0 border-b-2 border-blue-900 outline-none' />
              </div>

              <div className='flex flex-col w-full'>
                <label className='text-sm text-blue-900 pb-10'>Mobile</label>
                <input type='text' className='w-full bg-transparent border-0 border-b-2 border-blue-900 outline-none' />
              </div>
            </div>
          </form>
