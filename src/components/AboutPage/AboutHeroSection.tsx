...
const AboutHeroSection = () => {
  return (
    <div className="flex flex-col h-[100vh] p-10">
      ...
      <h1 className='text-7xl font-bold text-blue-400'>Rising Consult Firm</h1>
      <p className='text-blue-800'>With a focus on quality, integrity, and personalized service, we have established
